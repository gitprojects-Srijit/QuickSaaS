...
import sql from "../configerations/db.js";
...
export const generateArticle = async (req, res)=>{
    try {
        ...
        if(plan !== 'premium' && free_usage >= 30){
            return res.json({success: false, message: "You have reached your limit. Upgrade to continue further."})
        }
...
export const generateImage = async (req, res) => {
  try {
    ...
    // ✅ check free usage properly
    if (plan !== "premium" && free_usage >= 10) {
      return res.json({
        success: false,
        message: "Ater 10 times of uses this feature is only available for premium subscriptions",
      });
    }

    // ✅ FormData is imported properly
...
export const removeBackgroundImage = async (req, res)=>{
    try {
        ...
        if(plan !== 'premium' && free_usage >= 10){
            return res.json({success: false, message: "Ater 10 times of uses this feature is only available for premium subscriptions"})
        }
